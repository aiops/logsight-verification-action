...
| :arrows_counterclockwise: Freq. change states    |    {verification_result['frequencyChangeTotalCount']}  | {verification_result['frequencyChangeFaultPercentage']['increase']} {verification_result['frequencyChangeFaultPercentage']['decrease']} |  :arrow_up: {verification_result['frequencyChangeReportPercentage']['increase']} :arrow_down: {verification_result['frequencyChangeReportPercentage']['decrease']}  |
